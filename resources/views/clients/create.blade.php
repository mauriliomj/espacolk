                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('submit') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" id="phone" name="phone" class="mt-1 block w-full" value="{{ old('phone') }}" required>
                        </div>

                        <div class="mt-4">
                            <label for="birth_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Data de Nascimento</label>
                            <input type="date" id="birth_date" name="birth_date" class="mt-1 block w-full" value="{{ old('birth_date') }}" required>
                        </div>

                        <div class="mt-4">
                            <label for="observations" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Observações</label>
                            <textarea id="observations" name="observations" class="mt-1 block w-full">{{ old('observations') }}</textarea>
                        </div>
